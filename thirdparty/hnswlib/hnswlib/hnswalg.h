...
#include "knowhere/feder/IDSet.h"
...
class HierarchicalNSW : public AlgorithmInterface<dist_t> {
 public:
    ...
    searchBaseLayerST(tableint ep_id, const void* data_point, size_t ef, const faiss::BitsetView bitset,
                      ...
                      knowhere::feder::hnsw::FederResult* feder_result = nullptr) const {
            ...
            for (size_t j = 1; j <= size; j++) {
                ...
                if (!(visited_array[candidate_id] == visited_array_tag)) {
                    ...
                    if (feder_result != nullptr) {
                        ...
                        feder_result->id_set_.Add(current_node_id);
                        feder_result->id_set_.Add(candidate_id);
                    }
            ...
            while (changed) {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    if (feder_result != nullptr) {
                        ...
                        feder_result->id_set_.Add(currObj);
                        feder_result->id_set_.Add(cand);
                    }
